  ...
  return (
    <nav
      className="fixed top-0 left-0 z-50 w-full
                 border border-white/10 bg-white/9 backdrop-blur-md shadow-lg"
    >
      <div className="flex items-center justify-between px-5 py-3 text-3xl">
        ...
        <button
          className="hidden md:block rounded-full bg-white/10 px-4 py-2 text-sm 
                     text-white backdrop-blur-md hover:bg-white/20 transition"
        >
          Resume
        </button>
      ...
      {open && (
        ...
        >
          ...
          <button
            className="rounded-full bg-white/10 px-4 py-2 text-white text-lg 
